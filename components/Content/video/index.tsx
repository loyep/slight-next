...
const DefaultContent: NextPage<VideoContentProps> = (props: Partial<VideoContentProps>) => {
  const { content } = props
  ...
  return (
    <div>
    <div className="post-video bg-dark py-lg-5">
        ...
        <div className="nc-light-gallery">
          <div className="wp-video">
            ...
            >
              <source
                type="video/mp4"
                src="https://cosy.demo.nicetheme.xyz/wp-content/uploads/2020/08/2020082703593057.mp4?_=1"
              />
              <a href="https://cosy.demo.nicetheme.xyz/wp-content/uploads/2020/08/2020082703593057.mp4">
                https://cosy.demo.nicetheme.xyz/wp-content/uploads/2020/08/2020082703593057.mp4
              </a>
            </video>
          </div>
        </div>
    ...
    <div className="container pt-4 pt-md-4 pt-lg-5">
      <div className="d-none d-md-block breadcrumbs mb-2 mb-md-3">
        <span itemProp="itemListElement">
          <Link href="/" >
            <span itemProp="name" className="text-muted">
              首页
            </span>
          </Link>
        </span>
        ...
        >
          ...
          >
                  ...
                  <div className="list-item py-2">
                    <div className="media media-3x2 col-5 mr-3">
                      <a
                        ...
                        className="media-content"
                        // style="background-image:url('https://cosy.demo.nicetheme.xyz/wp-content/uploads/2020/08/2020082618051895.jpg')"
                      ></a>
                    </div>
                    <div className="list-content p-0">
                      <div className="list-body">
                  ...
                  <div className="list-item py-2">
                    <div className="media media-3x2 col-5 mr-3">
                      <a
                        ...
                        className="media-content"
                        // style="background-image:url('https://cosy.demo.nicetheme.xyz/wp-content/uploads/2020/08/2020082618052175.jpg')"
                      ></a>
                      <div className="media-action">
                        <span className="btn btn-icon btn-secondary rounded-circle">
                          <span>
            ...
            >
              ...
              >
                {/* <div style="position: absolute; left: 0px; top: 0px; transition: all 0s ease 0s; width: 288px; height: 2147px;"></div> */}
              </div>
              <div
